/* precons-data.js — Commander precon catalog (ported from the React web/src/data/precons).
   Classic script: defines window.MTGPrecons = [{id,name,set,setName,year,colors,commanderName,theme,decklist}] */
(function () {
/**
...
const KARLOV_MANOR_COMMANDER_2024 = [
  {
...
const BLOOMBURROW_COMMANDER_2024 = [
  {
